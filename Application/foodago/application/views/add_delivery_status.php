<?php
	if(isset($this->session->userdata['logged_in'])){
		...
		if(in_array('Create Delivery Status', $this->session->userdata['user_privileges'])){
			// CONTINUE
		}else{
	...
	<body>
		<div class="row">
			...
			<div class="col-md-12 grid body">
				<?php
					echo form_open('/Delivery_Status_Controller/newDeliveryStatus');
				?>
				<label for="name">Delivery Status Name </label>
