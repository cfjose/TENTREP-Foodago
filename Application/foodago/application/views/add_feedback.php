<?php
	if(isset($this->session->userdata['logged_in'])){
		...
		if(in_array('Create Feedbacks', $this->session->userdata['user_privileges'])){
			// CONTINUE
		}else{
	...
	<body>
		<div class="row">
			...
			<div class="col-md-12 grid body">
				...
				?>
				<label for="remark">Feedback Description </label>
				<textarea name="remark" class="form-control"></textarea><br/>
