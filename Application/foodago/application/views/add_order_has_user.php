<?php
	if(isset($this->session->userdata['logged_in'])){
		...
		if(in_array('Create User Orders', $this->session->userdata['user_privileges'])){
			// CONTINUE
		}else{
	...
	<body>
		<div class="row">
			...
			<div class="col-md-12 grid body">
				<?php
					echo form_open('/Order_Has_User_Controller/newOrderHasUser');
				?>
				...
				<label for="indv_amt">Order Amount </label>
				<input type="text" name="indv_amt" class="form-control"/>
