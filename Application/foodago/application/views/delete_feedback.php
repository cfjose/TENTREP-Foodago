<?php
	if(isset($this->session->userdata['logged_in'])){
		...
		if(in_array('Delete Feedbacks', $this->session->userdata['user_privileges'])){
			// CONTINUE
		}else{
	...
	<body>
		<div class="row">
			...
			<div class="col-md-12 grid body">
				<?php
					echo form_open('/Feedback_Controller/deleteFeedback');
				?>
				<input type="hidden" name="id" value="<?php echo $_GET['refid']; ?>"/>
				<p>Are you sure you want to delete the item from feedbacks list?</p>
			</div>
			<div class="col-md-12 grid header">
