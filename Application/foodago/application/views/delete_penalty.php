<?php
	if(isset($this->session->userdata['logged_in'])){
		...
		if(in_array('Delete Penalty', $this->session->userdata['user_privileges'])){
			// CONTINUE
		}else{
	...
	<body>
		<div class="row">
			...
			<div class="col-md-12 grid body">
				<?php
					echo form_open('/Penalty_Controller/deletePenalty');
				?>
				<input type="hidden" name="id" value="<?php echo $_GET['refid']; ?>">
				<p>You are about to delete a user's penalty. Are you sure you want to continue?</p>
			</div>
			<div class="col-md-12 grid header">
