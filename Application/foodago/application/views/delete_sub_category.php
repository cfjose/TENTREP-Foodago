<?php
	if(isset($this->session->userdata['logged_in'])){
		...
		if(in_array('Delete Subcategories', $this->session->userdata['user_privileges'])){
			// CONTINUE
		}else{
	...
	<body>
		<div class="row">
			...
			<div class="col-md-12 grid body">
				<?php
					echo form_open('/Sub_Category_Controller/deleteSubCategory');

					$getSubCategory = $this->SubCategory->getSubCategoryById($_GET['refid']);
				?>
				<p>You are about to delete '<?php echo $getSubCategory->row('name'); ?>' from the system! This will also remove all assignments with associated restaurants and food items under '<?php echo $getSubCategory->row('name'); ?>' sub category. Are you sure you want to continue? This is NOT REVERSIBLE!</p>
			</div>
			<div class="col-md-12 grid header">
