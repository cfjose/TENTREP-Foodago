				  			...
				  			<ul id="flexiselDemo3">
								<li>
									<div class="offer-image">	
										<img src="<?php echo base_url(); ?>assets/images/home/index/samples/restaurent-1.jpg" class="img-responsive" alt="" />
									</div>
								</li>
								<li>
									<div class="offer-image">	
										<img src="<?php echo base_url(); ?>assets/images/home/index/samples/restaurent-2.jpg" class="img-responsive" alt="" />
									</div>
								</li>
								<li>
									<div class="offer-image">	
										<img src="<?php echo base_url(); ?>assets/images/home/index/samples/restaurent-3.jpg" class="img-responsive" alt="" />
									</div>
								</li>
								<li>
									<div class="offer-image">	
										<img src="<?php echo base_url(); ?>assets/images/index/samples/restaurent-4.jpg" class="img-responsive" alt="" />
									</div>
							    </li>
				 			</ul>
